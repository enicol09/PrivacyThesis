<template>
  <v-app id="inspire">
    <v-app-bar app color="light-grey 4">
      <v-avatar :tile="true">
        <v-img
      ...
      <v-toolbar-title> PrivacyUI </v-toolbar-title>
      <v-spacer></v-spacer>
      <v-btn
        text
        rounded
      ...
      >
        Tutorial
        <v-icon right dark> mdi-message-video </v-icon>
      </v-btn>
    </v-app-bar>
    ...
    <v-navigation-drawer v-model="drawer" absolute temporary>
      <v-list nav dense>
        ...
        >
          <v-list-item @click="mainpage = !mainpage" to="/">
            <v-list-item-icon>
